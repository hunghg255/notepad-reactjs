...
function AvatarForm({
  onSelect,
  defaultValue = 'https://res.cloudinary.com/hunghg255/image/upload/v1647578985/favicon_cktafr.png',
}: IAvatarFormProps) {
    ...
    <div>
      <img
        ...
        onError={({ currentTarget }) => {
          ...
          currentTarget.src =
            'https://res.cloudinary.com/hunghg255/image/upload/v1647578985/favicon_cktafr.png';
        }}
      />
